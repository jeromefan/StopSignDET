...
class GradCam:
    ...
    def __init__(self, model, layer_name, cls=None):
        ...
        target_layer = self.find_yolo_layer(self.model, layer_name)
    ...
    def find_yolo_layer(self, model, layer_name):
    ...
    def gradcam_nms(self, prediction, logits, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False,
